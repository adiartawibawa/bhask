                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-success" href="{{ url('admin/blog/categories/' . $category->id . '/edit') }}"><i class="far fa-edit"></i>
                                            @lang('blog::categories.btn_edit_label') </a>
                                        @endcan
                                        ...
                                        <a href="{{ url('admin/blog/categories/' . $category->id) }}" class="btn btn-sm btn-danger" onclick="
                                            ...
                                            @lang('blog::categories.btn_delete_label')
                                        </a>
