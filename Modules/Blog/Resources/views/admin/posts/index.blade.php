                                ...
                                <tbody>
                                    @forelse ($posts as $post)
                                        <tr>
                                            <td>{{ $post->title }}</td>
                                            <td><a
                                                    href="{{ url('admin/users/' . $post->user->id) }}">{{ $post->user->name }}</a>
                                            </td>
                                                ...
                                                @if ($post->trashed())
                                                    @can('delete_blog-posts')
                                                        <a class="btn btn-sm btn-warning"
                                                            href="{{ url('admin/blog/posts/' . $post->id . '/restore') }}"><i
                                                                class="fa fa-sync-alt"></i>
                                                            @lang('blog::posts.btn_restore_label') </a>
                                                        <a href="{{ url('admin/blog/posts/' . $post->id) }}"
                                                            ...
                                                            @lang('blog::posts.btn_delete_permanent_label')
                                                        </a>
                                                        <form id="delete-role-{{ $post->id }}"
                                                            action="{{ url('admin/blog/posts/' . $post->id) }}" method="POST">
                                                ...
                                                @else
                                                    @can('view_blog-posts')
                                                        <a class="btn btn-sm btn-info"
                                                            href="{{ url('post/' . $post->id) }}"><i
                                                                class="far fa-eye"></i>
                                                            @lang('blog::posts.btn_show_label') </a>
                                                    @endcan
                                                    @can('edit_blog-posts')
                                                        <a class="btn btn-sm btn-success"
                                                            href="{{ url('admin/blog/posts/' . $post->id . '/edit') }}"><i
                                                                class="far fa-edit"></i>
                                                            @lang('blog::posts.btn_edit_label') </a>
                                                    @endcan
                                                    @can('delete_blog-posts')
                                                        <a href="{{ url('admin/blog/posts/' . $post->id) }}"
                                                            ...
                                                            <i class="far fa-trash-alt"></i>
                                                            @lang('blog::posts.btn_delete_label')
                                                        </a>
                                                        <form id="delete-role-{{ $post->id }}"
                                                            action="{{ url('admin/blog/posts/' . $post->id) }}"
                                                            method="POST">
                                                            <input type="hidden" name="_method" value="DELETE">
                                                            @csrf
                                                        </form>
