<x-app-layout>
    <x-slot name="header_content">
        @if (empty($post))
            <h1>@lang('blog::posts.create_posts')</h1>
        @else
    ...
    <div>
        ...
        <div class="section-body">
            <h2 class="section-title">
                {{ empty($post) ? __('blog::posts.post_add_new') : __('blog::posts.post_update') }}
            </h2>
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-header">
                            <h4>{{ empty($post) ? __('blog::posts.add_card_title') : __('blog::posts.update_card_title') }}
                            </h4>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    @include('blog::admin.posts._nested_categories', ['categoryIds' =>
                                    !empty($categoryIds)
                                    ? $categoryIds : []])
                                </div>
                            </div>
