                                ...
                                <tbody>
                                    @forelse ($pages as $page)
                                        <tr>
                                            <td>{{ $page->title }}</td>
                                            <td><a
                                                    href="{{ url('admin/users/' . $page->user->id) }}">{{ $page->user->name }}</a>
                                            </td>
                                                ...
                                                @if ($page->trashed())
                                                    @can('delete_blog-pages')
                                                        <a class="btn btn-sm btn-warning"
                                                            href="{{ url('admin/blog/pages/' . $page->id . '/restore') }}"><i
                                                                class="fa fa-sync-alt"></i>
                                                            @lang('blog::pages.btn_restore_label') </a>
                                                        <a href="{{ url('admin/blog/pages/' . $page->id) }}"
                                                            ...
                                                            @lang('blog::pages.btn_delete_permanent_label')
                                                        </a>
                                                        <form id="delete-role-{{ $page->id }}"
                                                            action="{{ url('admin/blog/pages/' . $page->id) }}"
                                                            method="POST">
                                                ...
                                                @else
                                                    @can('view_blog-pages')
                                                        <a class="btn btn-sm btn-info"
                                                            href="{{ url('post/' . $page->id) }}"><i
                                                                class="far fa-eye"></i>
                                                            @lang('blog::pages.btn_show_label') </a>
                                                    @endcan
                                                    @can('edit_blog-pages')
                                                        <a class="btn btn-sm btn-success"
                                                            href="{{ url('admin/blog/pages/' . $page->id . '/edit') }}"><i
                                                                class="far fa-edit"></i>
                                                            @lang('blog::pages.btn_edit_label') </a>
                                                    @endcan
                                                    @can('delete_blog-pages')
                                                        <a href="{{ url('admin/blog/pages/' . $page->id) }}"
                                                            ...
                                                            <i class="far fa-trash-alt"></i>
                                                            @lang('blog::pages.btn_delete_label')
                                                        </a>
                                                        <form id="delete-role-{{ $page->id }}"
                                                            action="{{ url('admin/blog/pages/' . $page->id) }}"
                                                            method="POST">
